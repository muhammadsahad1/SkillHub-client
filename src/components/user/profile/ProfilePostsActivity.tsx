...
const ProfilePostsActivity = () => {
  ...
  if (isLoading) {
    return <div className="flex flex-col lg:flex-row bg-white rounded-lg shadow-lg overflow-hidden mb-4 font-poppins transform transition duration-300 hover:shadow-xl animate-pulse mt-12">
